 ...
 */
const MOCK_DATA = [
    { id: 101, title: "赛博霓虹", author: "NeoArtist", views: "2.3k", tags: ["Cyberpunk", "City", "Night"], src: "https://images.unsplash.com/photo-1555680202-c86f0e12f086?w=600&q=80" },
    { id: 102, title: "迷雾山脉", author: "NatureLens", views: "1.1k", tags: ["Nature", "Landscape"], src: "https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?w=600&q=80" },
    { id: 103, title: "极简几何", author: "ShapeMaster", views: "890", tags: ["Abstract", "3D", "Minimal"], src: "https://images.unsplash.com/photo-1509281373149-e957c6296406?w=600&q=80" },
    { id: 104, title: "未来机甲", author: "MechFan", views: "3.4k", tags: ["Sci-Fi", "Concept Art"], src: "https://images.unsplash.com/photo-1531746020798-e6953c6e8e04?w=600&q=80" },
    { id: 105, title: "静谧工位", author: "CodeVibe", views: "4.5k", tags: ["Workspace", "Tech"], src: "https://images.unsplash.com/photo-1493723843684-a63e689df6ae?w=600&q=80" },
    { id: 106, title: "深空探索", author: "SpaceX", views: "9k", tags: ["Space", "Star"], src: "https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=600&q=80" },
    { id: 107, title: "复古胶片", author: "RetroCam", views: "1.2k", tags: ["Film", "Street"], src: "https://images.unsplash.com/photo-1477959858617-67f85cf4f1df?w=600&q=80" },
    { id: 108, title: "抽象流体", author: "FluidArt", views: "560", tags: ["Art", "Colorful"], src: "https://images.unsplash.com/photo-1541701494587-cb58502866ab?w=600&q=80" },
    { id: 109, title: "孤独宇航员", author: "AstroBoy", views: "2.8k", tags: ["Digital Art"], src: "https://images.unsplash.com/photo-1446776811953-b23d57bd21aa?w=600&q=80" },
    { id: 110, title: "午夜东京", author: "CityWalker", views: "3.1k", tags: ["Japan", "Night"], src: "https://images.unsplash.com/photo-1503899036084-c55cdd92a3a8?w=600&q=80" },
];
                ...
                <div class="gallery-lightbox-details">
                    <div class="details-header">
                        <div style="display:flex; justify-content:space-between; align-items:start;">
                            <h2 id="lbTitle" style="margin:0; font-size:24px;">Title</h2>
                            <div class="detail-actions">
                                <button class="action-btn save-btn">❤</button>
                            </div>
                        </div>
                        <p id="lbAuthor" style="color:#888; margin-top:8px;">Author Name</p>
                    </div>
                    
                    <div class="details-body">
                        <div class="details-actions">
                            <button class="detail-btn primary">收藏作品</button>
                            <button class="detail-btn secondary">下载原图</button>
                        </div>
                        
                        <div style="margin-bottom:20px;">
                            <h4 style="margin-bottom:10px; color:#aaa;">统计</h4>
                            <div style="display:flex; gap:20px; color:#fff;">
                                <span>👁 <span id="lbViews">0</span> 浏览</span>
                                <span>❤ 128 喜欢</span>
                            </div>
                        </div>

                        <div>
                            <h4 style="margin-bottom:10px; color:#aaa;">标签</h4>
                            <div id="lbTags">
                                <!-- Tags injected here -->
                            </div>
                        </div>
